...
<g transform="translate(-148.24,-193.13)">
<text x="428.27" y="564.63" font-family="Cascadia, Fira Code, monospace" font-size="20" fill="#1e1e1e" text-anchor="start"><tspan x="428.27" dy="0">cần thêm session sau khi đăng nhập</tspan></text>
</g>
</svg>
    </div>
  </div>
